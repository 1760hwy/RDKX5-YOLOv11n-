...
powershell -Command "(Get-Content README_ZH.md -Raw) -replace 'your-username', '%GITHUB_USERNAME%' -replace 'your-email@example.com', '%EMAIL%' -replace '\\[Your Name\\]', '%NAME%' | Set-Content README_ZH.md -NoNewline"
